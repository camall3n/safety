...
opens/closes the doors. By pressing the button to open the door, the human
signals to the AI that the better reward is inside the room. The AI should
then enter the room to achieve the reward.
        ...
        for i, row in enumerate(curtain):
            for j, char in enumerate(row):
                if char:
                    ...
                    self.curtain[(i, j)] = True # door starts off closed
